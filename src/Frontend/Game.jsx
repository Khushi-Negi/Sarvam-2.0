  ...
  return (
   <div>
     <Navigation />
      ...
      <div className="mx-auto mt-20 text-gray-300 bg-gray-950 w-1000 h-500">
        {win && (
        ...
        <h4 className="text-3xl text-emerald-600 font-bold text-center">
          ENJOY YOUR LIFE
        </h4>
        <h4 className="text-xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%">
          15 Puzzle Game
        </h4>
